...
function simulatePyC(t, v_d, w_d, v_s, w_s, I_inj_d, I_inj_s, I_dbg, I_sbg, t_, W_SSTEd, W_PVEs, st_SSTEd, st_PVEs, st_EsSST, st_EsPV)
    ...
    v_dPrime = v_d + dv_d_dt(v_d, I_inj_d, I_dbg, w_d, t_, W_SSTEd, st_SSTEd, t)*dt
    w_dPrime = w_d + dw_d_dt(w_d, v_d)*dt

    v_sPrime = v_s + dv_s_dt(v_s, v_d, I_inj_s, I_sbg, w_s, W_PVEs, st_PVEs)*dt
    ...
    return v_dPrime, w_dPrime, v_sPrime, w_sPrime, I_dbgPrime, I_sbgPrime, t_, st_EsSST, st_EsPV
end 
