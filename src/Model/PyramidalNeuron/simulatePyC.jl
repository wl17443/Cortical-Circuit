...
function simulatePyC(t, dt, v_d, w_d, v_s, w_s, I_inj_d, I_inj_s, I_dbg, I_sbg, t_, t_soma, st_SSTE, st_PVE, st_EE, W_SSTE, W_PVE, W_EE)
    ...
    I_dbg += dI_dbg_dt(I_dbg, dt) .* dt
    I_sbg += dI_sbg_dt(I_sbg, dt) .* dt
